...
If you are building local workflow tooling around Rocketboard itself, use the public CLI JSON contract in [docs/WORKFLOW_OPERATOR_API.md](./docs/WORKFLOW_OPERATOR_API.md). Do not consume git-ignored operator state files or scrape the human-oriented workflow command output.

## Contribution Workflow

This public repository is a mirror of the development repository. When you submit a PR:

1. The maintainer reviews and merges your PR in this public repo
2. Changes are then ported to the development repository
...
The hosted version at rocketboard.app includes additional infrastructure not present here:

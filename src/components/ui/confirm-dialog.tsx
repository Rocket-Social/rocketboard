  ...
  return (
    <AlertDialogPrimitive.Root open={open} onOpenChange={(v) => { if (!v) onCancel() }}>
      <AlertDialogPrimitive.Portal>
        <AlertDialogPrimitive.Overlay className='fixed inset-0 z-[90] bg-slate-950/40 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0'/>
        <AlertDialogPrimitive.Content className='fixed left-1/2 top-1/2 z-[90] w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border-subtle bg-surface-elevated p-6 shadow-md'>
  ...
  return (
    <AlertDialogPrimitive.Root open={open} onOpenChange={(v) => { if (!v) onCancel() }}>
      <AlertDialogPrimitive.Portal>
        <AlertDialogPrimitive.Overlay className='fixed inset-0 z-[90] bg-slate-950/40 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0'/>
        <AlertDialogPrimitive.Content
          className='fixed left-1/2 top-1/2 z-[90] w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border-subtle bg-surface-elevated p-6 shadow-md'

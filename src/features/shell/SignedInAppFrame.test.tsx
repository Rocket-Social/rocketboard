...
vi.mock("@tanstack/react-query", () => ({
  ...
  // Inbox realtime hook (mounted globally in SignedInAppFrame) calls
  // useQueryClient to grab the cache. The test never asserts on cache
  // invalidation, so a no-op stub is enough.
  useQueryClient: () => ({
...
// Inbox realtime hook touches the supabase client; the warmup test only
// cares about the SignedInAppFrame's preload effect, so stub it out.
vi.mock("../inbox/inbox.realtime", () => ({

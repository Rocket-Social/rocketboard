...
type WorkspaceSidebarChromeProps = {
  ...
  onOpenCommandPalette: () => boolean | void;
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-1">
            <button
              className={`hidden rounded-lg p-1.5 transition-colors lg:inline-flex ${sidebarButtonBase}`}
            ...
            <button
              className={`rounded-lg p-1.5 transition-colors lg:hidden ${sidebarButtonBase}`}
              onClick={onMobileSidebarClose}
              type="button"
            >
              <X className="h-4 w-4" />

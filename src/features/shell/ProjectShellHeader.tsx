...
import {Bot, Building2, ChevronDown, Lock, Menu, Sparkles, UserPlus, Users} from 'lucide-react'
      ...
      <div className='mb-4 flex flex-wrap items-start justify-between gap-3 sm:gap-4'>
        <div className='flex min-w-0 flex-1 items-center gap-3'>
          ...
          <div className='min-w-0'>
            <h1
              className='-mx-1 max-w-full break-words rounded-md px-1 font-display text-xl font-semibold tracking-tight text-text-strong outline-none ring-primary focus:ring-2'
        ...
        <div className='flex shrink-0 flex-wrap items-center justify-end gap-2'>
          <HeaderSearchIconButton onOpen={props.onOpenCommandPalette}/>
          {props.onOpenAiChat ? (
            <Button

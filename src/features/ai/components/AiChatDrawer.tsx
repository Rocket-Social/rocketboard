...
export function AiChatDrawer({
  ...
  const conversationsQuery = useConversationsQuery(isOpen ? userId : '', isOpen ? surface : undefined)
  ...
  const handleSend = useCallback(
    ...
    [activePersona, conversationId, isStreaming, queryClient, surface, surfaceContext, userId],
  )
      ...
      >
        ...
        {showSuggested ? (
          <div className="flex flex-1 flex-col items-center justify-center">
            <SuggestedPrompts onSelect={handleSuggestedPrompt} surface={surface} />
          </div>
        ) : (
          <AiMessageList

...
export const DISABLE_AUTH_SESSION_SYNC = import.meta.env.DEV && import.meta.env.VITE_DISABLE_AUTH_SESSION_SYNC === 'true'
export const ENABLE_E2E_HARNESS = import.meta.env.DEV && import.meta.env.VITE_ENABLE_E2E_HARNESS === 'true'

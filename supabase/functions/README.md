...
Rocketboard is RPC-first for core product CRUD, but this repo includes Edge Functions for true server-side capabilities such as webhooks, outbound email, imports, billing, and AI request handling.

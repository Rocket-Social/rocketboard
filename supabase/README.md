...
Rocketboard stays RPC-first for product CRUD and aggregate reads. This repo also includes app-owned Edge Functions for server-only capabilities such as GitHub callbacks, email invites, imports, billing, and AI handling. The generated Fair Source mirror strips hosted-only billing and internal admin pieces during release prep.
